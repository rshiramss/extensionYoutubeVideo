...
# Configure port - changed to port 5000 which is less likely to be in use
PORT = 5000
...
@app.route('/')
def test():
    return jsonify({"status": "ok", "message": "Server is running", "port": PORT})
...
if __name__ == '__main__':
    try:
        ...
        logger.info("Please check if the port is already in use or try another port.")
